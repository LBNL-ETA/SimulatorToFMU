...
SET MOD_DLL=SimulatorToFMUPython34.dll
SET MOD_LIB=SimulatorToFMUPython34.lib
...
IF %ERRORLEVEL% == 0 (
  ...
  SET PYTHONLibs="C:\Python34\libs\python27.lib"
  ...
  SET BINDIR=..\..\..\Library\win32 
    ...
    SET PYTHONLibs="C:\Python34_x64\libs\python27.lib"
