...
model SimulatorWithPassPythonObject
  ...
  SimulatorToFMU.Python34.Functions.BaseClasses.PythonObject pytObj=
      SimulatorToFMU.Python34.Functions.BaseClasses.PythonObject();
...
algorithm
  ...
  annotation (
    ...
    __Dymola_Commands(file="modelica://SimulatorToFMU.Resources/Scripts/Dymola/Python34/Functions/Examples/SimulatorWithPassPythonObject.mos"
        "Simulate and plot"),
