...
parser_path = os.path.abspath(os.path.join(script_path, '..', 'SimulatorToFMU'))
sys.path.append(parser_path)

import SimulatorToFMU.SimulatorToFMU as simulator
...
utilities_path = os.path.join(script_path, '..', 'SimulatorToFMU', 'utilities')
...
SimulatorToFMU_LIB_PATH = os.path.join(
    script_path, '..', 'SimulatorToFMU', 'libraries', 'modelica')
