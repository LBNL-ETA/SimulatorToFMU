...
SET MOD_DLL=SimulatorToFMUPython2.7.dll
SET MOD_LIB=SimulatorToFMUPython2.7.lib
...
IF %ERRORLEVEL% == 0 (
  ...
  SET PYTHONInc="C:\Program Files (x86)\Python 2.7\include"
  SET PYTHONLibs="C:\Program Files (x86)\Python 2.7\libs\python27.lib"
  ...
  SET BINDIR=..\..\..\Library\win32 
    ...
    SET PYTHONInc="C:\Program Files\Python 2.7\include"
    SET PYTHONLibs="C:\Program Files\Python 2.7\libs\python27.lib"
