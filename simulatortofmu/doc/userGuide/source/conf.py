...
copyright = u'2022, The Regents of the University of California (through Lawrence Berkeley National Laboratory)'
...
html_title = "FMU Export of a Python-driven Simulation Program User Guide"
...
latex_documents = [
  ('index', 'userGuide.tex', u'FMU Export of a Python-driven Simulation Program',
